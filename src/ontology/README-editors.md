These notes are for the EDITORS of cdno
...
Make sure you have an ID range in the [idranges file](cdno-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [cdno-edit.owl](cdno-edit.owl)

** DO NOT EDIT cdno.obo OR cdno.owl in the top level directory **

[../../cdno.owl](../../cdno.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/Southern-Cross-Plant-Science/cdno) for details.
 ...
 * [cdno-idranges.owl](cdno-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/cdno_terms.txt file
...
Note: the cdno_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as cdno.owl and cdno.obo and places
 ...
 * https://github.com/Southern-Cross-Plant-Science/cdno/releases
 * https://github.com/Southern-Cross-Plant-Science/cdno/releases/new
...
what is in the `owl:versionIRI` of the derived cdno.owl (`data-version` in
cdno.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/cdno.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/cdno/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/Southern-Cross-Plant-Science/cdno.svg?branch=master)](https://travis-ci.org/Southern-Cross-Plant-Science/cdno)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/Southern-Cross-Plant-Science](https://travis-ci.org/profile/Southern-Cross-Plant-Science)
 2. click the "Sync account" button
 3. Click the tick symbol next to cdno
