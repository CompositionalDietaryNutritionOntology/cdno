 ...
 * [cdno.yml](cdno.yml)
     * Determines how your purl.obolibrary.org/obo/cdno/ redirects will be handled
     ...
     * Paste in the contents of [cdno.yml](cdno.yml)
 ...
 * [cdno.md](cdno.md)
     ...
     * Paste in the contents of [cdno.md](cdno.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
